...
# attention num for bap
_C.MODEL.HEADS.ATTN = 1

# GAN enable
_C.MODEL.HEADS.GAN = False
_C.MODEL.HEADS.GAN_RATIO = 0.

# ADDTION_POOL
_C.MODEL.HEADS.ADDTION_POOL = ""

_C.MODEL.HEADS.NUM_CHUNK = 2
...
_C.MODEL.LOSSES.CE.ATTN_SCALE = 1.0
_C.MODEL.LOSSES.CE.MAIN_SCALE = 1.0
...
_C.MODEL.LOSSES.TRI.ATTN = False
