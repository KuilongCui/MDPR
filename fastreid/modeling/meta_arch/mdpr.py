...
class MDPR(nn.Module):
    ...
    @configurable
    def __init__(
            self, *, output_all, output_dir, attn_guide, pixel_mean, pixel_std, feat_dim, backbone_embedding_dim, \
            attn_num, backbone, attn_backbone, attn_feature4_head, attn_feature3_head, \
            attn_bap_feature4_head, attn_bap_feature3_head, part_backbone, hard_global_head, part_num, hard_part_head, \
            fusion_feat_head, loss_kwargs
    ):
        """
