...
class RepVggSbaseline(nn.Module):
    """
    ...
    def __init__(
        ...
        self.attnShaped3 = AttnShaped(self.feat_dim//4, with_ibn=with_ibn, norm_type=norm_type, attnShaped_activation=attnShaped_activation)
        self.attnShaped2 = AttnShaped(self.feat_dim//8, with_ibn=with_ibn, norm_type=norm_type, attnShaped_activation=attnShaped_activation)
        self.attnShaped1 = AttnShaped(self.feat_dim//16, with_ibn=with_ibn, norm_type=norm_type, attnShaped_activation=attnShaped_activation)
    ...
    def from_config(cls, cfg):
        ...
        backbone1 = nn.Sequential(
            copy.deepcopy(all_blocks.stage2),
            copy.deepcopy(all_blocks.stage3),
            copy.deepcopy(all_blocks.stage4)
        )
    ...
    def forward(self, batched_inputs):
        ...
        # torch.Size([64, 160, 96, 48])
        # torch.Size([64, 320, 48, 24])
        # torch.Size([64, 640, 24, 12])
        # torch.Size([64, 2560, 24, 12])
