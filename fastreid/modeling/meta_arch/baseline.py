...
class Baseline(nn.Module):
    ...
    def __init__(
        ...
        if 'CenterLoss' in self.loss_kwargs['loss_names']:
            ...
            self.center = CenterLoss(num_classes=num_class, feat_dim=dim*num_attn)
    ...
    def forward(self, batched_inputs):
        ...
        _,_,_,features = self.backbone(images)
        ...
        if self.training:
            ...
            outputs = self.heads(features, targets, batched_inputs=batched_inputs)
            losses = self.losses(outputs, targets)
                
            return losses
        else:
            outputs = self.heads(features, batched_inputs=batched_inputs)
            return outputs
    ...
    def losses(self, outputs, gt_labels):
        ...
        if 'CenterLoss' in loss_names:
            ...
            loss_dict['loss_center'] = self.center(
                pred_features,
                gt_labels,
